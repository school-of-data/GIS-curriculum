...
*   Internet access
*   QGIS 3.16 or later
*   [Topo Map of Kitale, Kenya](https://drive.google.com/drive/folders/1aDGYnXZaxmeMm0G4L4zpDEZbiC5UWNyN?usp=sharing)
...
4. Click the ![alt_text](media/dots.png "image_tooltip") icon next to the Output raster box, go to the folder and create the folder 'kitale data’ and name the file as kitale_georef.tif.
