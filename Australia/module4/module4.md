...
*   Internet connection
*   QGIS 3.16 or later
*   Tasmania administrative boundary layer (inside [module4.gpkg](data/module4.gpkg))
*   Tasmania clinics (inside [module4.gpkg](data/module4.gpkg))
*   [AU_Tasmania High Resolution Settlement Layer](data/HRSL_AU_Tasmania_Population.tif)
...
1. To demonstrate this example, we’ll use two example datasets; 1. [Clinics](https://drive.google.com/file/d/1iJQ1nP0ulA96OhyT9wakRheahYKnNmjc/view?usp=sharing) and 2. [Administrative boundary](https://drive.google.com/file/d/1GiFmr4As5e-yn-4lCqotAzUBHzXU1NS_/view?usp=sharing) of Tasmania 
...
4. Double click the polygon vector layer, which is also the administrative boundary layer of Tasmania, Australia
...
4. Specify the interpolation, color ramp and mode. Click classify. The result is a choropleth map showing population density across Tasmania, Australia.

![Population density of Tasmania, Australia](media/hrsl-style.png "Population density of Tasmania, Australia")

Figure 4.8: Population density of Tasmania, Australia
