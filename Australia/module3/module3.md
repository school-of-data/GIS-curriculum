...
*   Tasmania and Hobart vector layers (inside [module3.gpkg](module3.gpkg)).
...
or this exercise, we will load road network data and locations of fast food chains from OSM that can be found in the Tasmania using the QuickOSM plugin.
...
1. Load the Tasmania and Hobart vector layers found inside the module3 geopackage.

![Tasmania and Hobart layers loaded in QGIS](media/quickosm-1.png "Tasmania and Hobart layers loaded in QGIS")

Figure 3.2. Tasmania and Hobart layers loaded in QGIS
...
4. Load all highways inside the extent of the Hobart layer.
...
![Load all highways in the Hobart layer extent](media/quickosm-3.png "Load all highways in the Hobart layer extent")

Figure 3.4. Load all highways in the Hobart layer extent
...
8. Next, let’s load all fast food restaurant locations in the Tasmania layer extent. Open the QuickOSM plugin and put the following parameters in the Quick query tab:

    * Key: amenity
    * Value: fast_food
    * Layer Extent: Tasmania
    * Advanced:
        * Check Node, Way, Relation, Points

![Load amenities (points) tagged as fast_food in the Tasmania layer extent](media/quickosm-6.png "Load amenities (points) tagged as fast_food in the Tasmania layer extent")

Figure 3.7: Load amenities (points) tagged as fast_food in the Tasmania layer extent
...
1. Load the **HRSL_AU_Tasmania_Population** raster file in QGIS.

![The HRSL for Tasmania, Australia](media/hrsl-1.png "The HRSL for Tasmania, Australia")

Figure 3.10: The HRSL for Tasmania, Australia
