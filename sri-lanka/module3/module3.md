...
*   Colombo_admin_boundary and Thimbirigasyaya_admin_boundary vector layers (inside [module3.gpkg](module3.gpkg)).
...
1. Load the Colombo_admin_boundary and Thimbirigasyaya_admin_boundary vector layers found inside the module3 geopackage.
...
4. Load all highways inside the extent of the Thimbirigasyaya_admin_boundary layer.

    * Key: highway
    * Value: &lt;blank> (blank means ALL)
    * Layer Extent: Thimbirigasyaya_admin_boundary
    * Advanced:
        * Check Node, Way, Relation, Lines, Multilinestrings

![Load all highways in the Thimbirigasyaya_admin_boundary layer extent](media/quickosm-3.png "Load all highways in the Thimbirigasyaya_admin_boundary layer extent")

Figure 3.4. Load all highways in the Thimbirigasyaya_admin_boundary layer extent
...
8. Next, let’s load all fast food restaurant locations in the Colombo_admin_boundary layer extent. Open the QuickOSM plugin and put the following parameters in the Quick query tab:

    * Key: amenity
    * Value: fast_food
    * Layer Extent: Colombo_admin_boundary
    * Advanced:
...
Figure 3.7: Load amenities (points) tagged as fast_food in the Colombo_admin_boundary layer extent
