...
<table>
  ...
  <tr>
   ...
   <td>christian;christian_orthodox;taoist;hindu;muslim_sunni;muslim;buddhist;christian_catholic
   </td>
  </tr>
  <tr>
   <td> roads 
   ...
   <td>bridleway;tertiary_link;primary;primary_link;unclassified;footway;steps;residential;secondary;motorway;cycleway;trunk_link;unknown;service;track_grade1;path;track;secondary_link;track_grade2;pedestrian;tertiary;living_street;track_grade3;track_grade4;trunk;motorway_link;track_grade5
   </td>
  </tr>
  <tr>
   <td>landuse
   ...
   <td>grass;nature_reserve;farmland;cemetery;residential;quarry;retail;scrub;park;farmyard;military;vineyard;orchard;allotments;forest;commercial;meadow;heath;recreation_ground;industrial
   </td>
  </tr>
</table>
...
![Creating a 10X10km vector grid for the Bangalore district](media/fig829_a.png "Creating a 10X10km vector grid for the Bangalore district")
...
![10X10km vector grid for the Bangalore district](media/fig829_b.png "10X10km vector grid for the Bangalore district")
...
![Filtering green areas and built-up space in Bangalore](media/fig830_a.png "Filtering green areas and built-up space in Bangalore ")

Figure 8.30a - Filtering green areas and built-up space in Bangalore 


![Spatial distribution of the green areas and built-up space in Bangalore](media/fig830_b.png "Spatial distribution of the green areas and built-up space in Bangalore")
...
![Fictitious precipitation data for the 93 fictitious meteo stations in Bangalore district](media/fig845.png "Fictitious precipitation data for the 93 fictitious meteo stations in Bangalore district")
