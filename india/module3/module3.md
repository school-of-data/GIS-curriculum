...
*   IND_Bangalore and IND_BangaloreNorth vector layers (inside [module3.gpkg](module3.gpkg)).
...
or this exercise, we will load road network data and locations of fast food chains from OSM that can be found in the province of Bangalore using the QuickOSM plugin.
...
1. Load the IND_Bangalore and IND_BangaloreNorth vector layers found inside the module3 geopackage.

![Colombo layers loaded in QGIS](media/quickosm-1.png "Colombo layers loaded in QGIS")

Figure 3.2. Colombo layers loaded in QGIS
...
4. Load all highways inside the extent of the IND_BangaloreNorth layer.

    * Key: highway
    * Value: &lt;blank> (blank means ALL)
    * Layer Extent: IND_BangaloreNorth
    * Advanced:
        * Check Node, Way, Relation, Lines, Multilinestrings

![Load all highways in the IND_BangaloreNorth layer extent](media/quickosm-3.png "Load all highways in the IND_BangaloreNorth layer extent")

Figure 3.4. Load all highways in the IND_BangaloreNorth layer extent
...
8. Next, let’s load all fast food restaurant locations in the IND_Bangalore layer extent. Open the QuickOSM plugin and put the following parameters in the Quick query tab:

    * Key: amenity
    * Value: fast_food
    * Layer Extent: IND_Bangalore
    * Advanced:
        * Check Node, Way, Relation, Points

![Load amenities (points) tagged as fast_food in the IND_Bangalore layer extent](media/quickosm-6.png "Load amenities (points) tagged as fast_food in the IND_Bangalore layer extent")

Figure 3.7: Load amenities (points) tagged as fast_food in the IND_Bangalore layer extent
...
1. Load the **HRSL_Colombo_Population** raster file in QGIS.

![The HRSL for Colombo, Sri Lanka](media/hrsl-1.png "The HRSL for Colombo, Sri Lanka")

Figure 3.10: The HRSL for Colombo, Sri Lanka
