...
*   Internet access
*   QGIS 3.16 or later
*   [Topo Map of Bangalore, India](data/nd-44-13a.jpg)
...
4. Click the ![alt_text](media/dots.png "image_tooltip") icon next to the Output raster box, go to the folder and create the folder 'bangalore data’ and name the file as bangalore_georef.tif.
