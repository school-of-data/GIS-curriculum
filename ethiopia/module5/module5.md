...
*   Internet access
*   QGIS 3.16 or later
*   Addis Ababa administrative boundary layer (inside [module5.gpkg](data/module5.gpkg))
*   Addis Ababa clinics (inside [module5.gpkg](data/module5.gpkg))
*   ETH zones (inside [module5.gpkg](data/module5.gpkg))
*   [Addis Ababa High Resolution Settlement Layer](data/HRSL_Addis_Ababa_Population.tif)
...
1. In this tutorial, we’ll make a map showing the 1.) location of health centres and 2.) population density of Addis Ababa city in Ethiopia. The data layers should already be added to the QGIS canvas. The layers can then be styled to communicate information in your data.

![Creating new Print Layout](media/new-print-layout.png "Creating new Print Layout")

Figure 5.4: Creating new Print Layout

2. The map canvas can now be exported to the print Layout. Click the ‘new print layout layout button’ ![New Print Layout](media/newprint_composer.png "New Print Layout"). This can be accessed via the tool bar. Alternatively, access using the ‘Projects’ menu bar. A title dialogue will open, prompting you to type the title of the Print Layout. Type ‘Addis Ababa’ and Click OK.
...
1. This layer will serve as out coverage layer which means that the QGIS Atlas will 1 map for each of the features in this coverage layer. All in all, 79 maps will be generated.
...
6. To preview your Atlas, click on the Preview Atlas button ![Preview Atlas button](media/atlas-preview-btn.png "Preview Atlas button") on the Atlas Toolbar. This will show you the 79 maps that you generated. Use the Atlas toolbar ![Atlas toolbar](media/atlas-toolbar-nav.png "Atlas toolbar") to navigate the Atlas maps. 

![Atlas Preview](media/atlas-preview.png "Atlas Preview")

Figure 5.18: Atlas Preview

7. You can export the Atlas maps via the **Export Atlas** button ![Export Atlas button](media/atlas-export-btn.png "Export Atlas button") either as images or PDFs. Select **Export Atlas as Image**. You should have 79 maps generated wher each map shows the extent of the province.
