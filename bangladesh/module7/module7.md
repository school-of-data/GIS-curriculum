...
4. Click the ![alt_text](media/dots.png "image_tooltip") icon next to the Output raster box, go to the folder and create the folder 'bangladesh_data’ and name the file as bangladesh_georef.tif.
...
10. In the Enter map coordinates dialogue write the coordinates that appear in the map (Y: 23° 00’ 00’’ and X: 90° 00’ 00’’).
