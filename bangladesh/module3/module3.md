...
1. Load the Rajshahi_division and Rajshahi_district vector layers found inside the module3 geopackage.

![Rajshahi layers loaded in QGIS](media/quickosm-1.png "Rajshahi layers loaded in QGIS")
...
4. Load all highways inside the extent of the Rajshahi_district layer.

    * Key: highway
    * Value: &lt;blank> (blank means ALL)
    * Layer Extent: Rajshahi_district
    * Advanced:
        * Check Node, Way, Relation, Lines, Multilinestrings

![Load all highways in the Rajshahi_district layer extent](media/quickosm-3.png "Load all highways in the Rajshahi_district layer extent")
...
8. Next, let’s load all fast food restaurant locations in the Rajshahi_division layer extent. Open the QuickOSM plugin and put the following parameters in the Quick query tab:

    * Key: amenity
    * Value: fast_food
    * Layer Extent: Rajshahi_division
    * Advanced:
        * Check Node, Way, Relation, Points

![Load amenities (points) tagged as fast_food in the Rajshahi_division layer extent](media/quickosm-6.png "Load amenities (points) tagged as fast_food in the Rajshahi_division layer extent")
...
1. Load the **HRSL_BGD_Rajshahi_Population** raster file in QGIS.

![The HRSL for Rajshahi, Bangladesh](media/hrsl-1.png "The HRSL for Rajshahi, Bangladesh")
