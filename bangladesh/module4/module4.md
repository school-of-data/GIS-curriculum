...
1. To demonstrate this example, we’ll use two example datasets; 1. [Clinics](https://drive.google.com/file/d/1iJQ1nP0ulA96OhyT9wakRheahYKnNmjc/view?usp=sharing) and 2. [Administrative boundary](https://drive.google.com/file/d/1GiFmr4As5e-yn-4lCqotAzUBHzXU1NS_/view?usp=sharing) of Rajshahi division 
...
4. Double click the polygon vector layer, which is also the administrative boundary layer of Rajshahi division in Bangladesh
...
4. Specify the interpolation, color ramp and mode. Click classify. The result is a choropleth map showing population density across Rajshahi division in Bangladesh.

![Population density of Rajshahi division, Bangladesh](media/hrsl-style.png "Population density of Rajshahi division, Bangladesh")

Figure 4.8: Population density of Rajshahi division, Bangladesh
