...
Figure 9.1 - مصفوفة منتظمة من القيم
...
Figure 9.2 - على الجانب الأيسر، يتم تعيين القيم إلى <strong>النقط الوسطى</strong>  
...
![Example of a histogram, where x is a raster layer](media/fig95.png "Example of a histogram, where x is a raster layer")
 ...
 Figure 9.5 - مثال على الرسم البياني لطبقة نقطية
...
Figure 9.8 - وظائف إعادة إسقاط المشروع  
...
Figure 9.9.a -نافذة إعادة الإسقاط (Warp) 
...
Figure 9.9.b - إعادة إسقاط طبقة HRSL 
...
Figure 9.14 -العثور على أداة الدّمح GDAL في مربّع أدوات المعالج
...
Figure 9.15.c - فسيفساء لجميع ملفّات DSM المطابقة لمنطقة عملنا
...
Figure 9.18 -تكبير الرسم البياني المحسوب على طبقة Reprojected_Merged_SRTM_DEM 
...
Figure 9.24 - طبقات نقطية مقصوصة بواسطة طبقة حدود القاهرة
...
Figure 9.25 - تمثيل clipped_Reprojected_Merged_SRTM  
...
Figure 9.29 - التوزيع المكاني لجميع وحدات البكسل ذات القيمة 1، بمعنى أن يكون الارتفاع أقل من 200 متر
...
Figure 9.38 - مثال على درجات دقة مختلفة خاصة بصور أقمار صناعية مختلفة SPOT & Landsat لنفس المنطقة. مصدر الصورة: (Congedo, L. and Munafò, M, (2013) Assessment of Land Cover Change Using Remote Sensing: Objectives, Methods and Results, Rome: Sapienza University. Available at: [http://www.planning4adaptation.eu/](http://www.planning4adaptation.eu/)_ 
...
Figure 9.41 - مقارن طبقتين نقطيتين باستخدام الرنامج المساعد MapSwipe Tool
...
Figure 9.43 -إضافة  HRSL  فوق Clipped_Reprojected_LandCover2019
...
Figure 9.44 - الفرق في الدقة المكانية بين HRSL (pinkish-30m) و  Clipped_Reprojected_LandCover2019 (red & magenta colors 100m)
...
Figure 9.48.a - الرسم البياني الخاص بـ Clipped_Reprojected_LandCover2019 (100m)

![alt_text](media/fig948_b.png "image_tooltip")

Figure 9.48.b - الرسم البياني الخاص بـ LC2019_NearestNeighbour

![alt_text](media/fig948_c.png "image_tooltip")

Figure 9.48.c - الرسم البياني الخاص بـ LC2019 Mode
...
Figure 9.49 -  المنتجان النقطيان المتراكبان LandCover2019 and HRSL
...
Figure 9.50.a - تحويل الطبقة النقطية LC2019_Mode (30m) إلى مضلّع

![alt_text](media/fig950_b.png "image_tooltip")

Figure 9.50.b- نتيجة تحويل الطبقة النقطية LC2019_Mode (30m) إلى مضلّع
...
Figure 9.52 - عدم تطابق وحدات بكسل  HRSL ومجموعة بيانات متّجه الغطاء الأرضي
...
Figure 9.55 - إنشاء ملف VRT  باستخدام مربّعات نقطيّة محدّدة
...
Figure 9.56 - البلاط النّقطي لـ  HRSL منطقة القاهرة
...
Figure 9.57 - تشغيل Raster pixels to points  لكل من البلاطات النقطية 

يجب أن تبدو نقاط المتجه الناتجة كما في Figure 9.58.

![alt_text](media/fig958.png "image_tooltip")

Figure 9.58 -مجموعة بيانات متجه نقطية لطبقة HRSL بقيم بكسل مخزّنة في عامود  VALUE
